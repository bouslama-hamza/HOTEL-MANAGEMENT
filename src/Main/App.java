...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws IOException, SQLException {
        ...
        if (Prop.getProperty("MainPage").equals("null")) {
            ...
            loader = new FXMLLoader(App.class.getResource("../Resources/VIEW/Employer/Authentification/LogIn.fxml"));

        } else if (Prop.getProperty("MainPage").equals("1")){
            loader = new FXMLLoader(App.class.getResource("../Resources/VIEW/Admin/Authentification/Login.fxml"));
        }
